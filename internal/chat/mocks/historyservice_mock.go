...
// AddMessage provides a mock function with given fields: ctx, sessionID, message
func (_m *MockHistoryService) AddMessage(ctx context.Context, sessionID string, message goai.ChatHistoryMessage) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, goai.ChatHistoryMessage) error); ok {
...
func (_e *MockHistoryService_Expecter) AddMessage(ctx interface{}, sessionID interface{}, message interface{}) *MockHistoryService_AddMessage_Call {
	return &MockHistoryService_AddMessage_Call{Call: _e.mock.On("AddMessage", ctx, sessionID, message)}
}

func (_c *MockHistoryService_AddMessage_Call) Run(run func(ctx context.Context, sessionID string, message goai.ChatHistoryMessage)) *MockHistoryService_AddMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(goai.ChatHistoryMessage))
	})
	return _c
}
...
func (_c *MockHistoryService_AddMessage_Call) RunAndReturn(run func(context.Context, string, goai.ChatHistoryMessage) error) *MockHistoryService_AddMessage_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetChat provides a mock function with given fields: ctx, sessionID
func (_m *MockHistoryService) GetChat(ctx context.Context, sessionID string) (*goai.ChatHistory, error) {
	...
	var r0 *goai.ChatHistory
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*goai.ChatHistory, error)); ok {
		return rf(ctx, sessionID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *goai.ChatHistory); ok {
		r0 = rf(ctx, sessionID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*goai.ChatHistory)
...
//   - ctx context.Context
//   - sessionID string
func (_e *MockHistoryService_Expecter) GetChat(ctx interface{}, sessionID interface{}) *MockHistoryService_GetChat_Call {
	return &MockHistoryService_GetChat_Call{Call: _e.mock.On("GetChat", ctx, sessionID)}
}

func (_c *MockHistoryService_GetChat_Call) Run(run func(ctx context.Context, sessionID string)) *MockHistoryService_GetChat_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockHistoryService_GetChat_Call) RunAndReturn(run func(context.Context, string) (*goai.ChatHistory, error)) *MockHistoryService_GetChat_Call {
	_c.Call.Return(run)
	return _c
}
