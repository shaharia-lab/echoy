...
func (_m *MockService) Chat(ctx context.Context, sessionID string, message string) (types.ChatResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (types.ChatResponse, error)); ok {
		return rf(ctx, sessionID, message)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) types.ChatResponse); ok {
...
func (_c *MockService_Chat_Call) Run(run func(ctx context.Context, sessionID string, message string)) *MockService_Chat_Call {
...
func (_c *MockService_Chat_Call) RunAndReturn(run func(context.Context, string, string) (types.ChatResponse, error)) *MockService_Chat_Call {
	_c.Call.Return(run)
	return _c
}

// ChatStreaming provides a mock function with given fields: ctx, sessionID, message
func (_m *MockService) ChatStreaming(ctx context.Context, sessionID string, message string) (<-chan goai.StreamingLLMResponse, error) {
	ret := _m.Called(ctx, sessionID, message)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (<-chan goai.StreamingLLMResponse, error)); ok {
		return rf(ctx, sessionID, message)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) <-chan goai.StreamingLLMResponse); ok {
		r0 = rf(ctx, sessionID, message)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockService_ChatStreaming_Call) Run(run func(ctx context.Context, sessionID string, message string)) *MockService_ChatStreaming_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *MockService_ChatStreaming_Call) RunAndReturn(run func(context.Context, string, string) (<-chan goai.StreamingLLMResponse, error)) *MockService_ChatStreaming_Call {
	_c.Call.Return(run)
	return _c
}

// GetChatHistory provides a mock function with given fields: ctx, chatUUID
func (_m *MockService) GetChatHistory(ctx context.Context, chatUUID string) (*goai.ChatHistory, error) {
...
func (_c *MockService_GetChatHistory_Call) Run(run func(ctx context.Context, chatUUID string)) *MockService_GetChatHistory_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_GetChatHistory_Call) RunAndReturn(run func(context.Context, string) (*goai.ChatHistory, error)) *MockService_GetChatHistory_Call {
	_c.Call.Return(run)
	return _c
}
